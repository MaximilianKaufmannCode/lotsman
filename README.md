...
**Лицензия — [Business Source License 1.1](LICENSE)** (BUSL-1.1) — это **source-available**, а не OSI-open-source лицензия. Разрешены копирование, изменение, распространение и некоммерческое использование; production-использование разрешено **за исключением** предложения Лоцмана третьим лицам как конкурирующего хостинг-сервиса или коммерческого продукта. Каждая версия автоматически переходит под **MPL-2.0** через 4 года после выпуска. Подробности и FAQ — **[LICENSING.md](LICENSING.md)**. Версии ≤ 1.29.9 были выпущены под MPL-2.0 и остаются доступными на тех условиях.
