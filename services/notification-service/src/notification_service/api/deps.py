...
from notification_service.infrastructure.db.session import get_session as _get_session
...
async def current_actor(
    ...
    try:
        return await verify_internal_jwt(
            settings.internal_jwt_key_notification,
            x_internal_token,
            expected_audience="notification-service",
        )
